...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item d-none d-sm-inline-block"><a
			href="${pageContext.request.contextPath}/admin/home" class="nav-link">Trang
				chủ</a></li>
		<li class="nav-item d-none d-sm-inline-block"><a
			href="${pageContext.request.contextPath}/admin/user_management"
			class="nav-link">Quản lý user</a></li>
		<li class="nav-item d-none d-sm-inline-block"><a
			href="${pageContext.request.contextPath}/admin/categories/list"
			class="nav-link">Quản lý danh mục</a></li>
	</ul>
	...
	<ul class="navbar-nav ml-auto">
		...
		<c:if test="${user-wellcome != null}">
			<li class="nav-item"><a class="nav-link"> <b>Wellcome!!!
						${userLogged.full_name}</b>
