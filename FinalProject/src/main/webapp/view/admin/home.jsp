...
<script src="${template}admin/js/pages/dashboard.js"></script>
<div class="wrapper">
							...
							<div class="card-body">
								...
								<div class="direct-chat-contacts">
									<ul class="contacts-list">
										...
										<!-- End Contact Item -->
										<li><div class="contacts-list-info">
												<a href="#"> <img class="contacts-list-img"
													src="dist/img/user3-128x128.jpg" alt="User Avatar"> <span
													class="contacts-list-name"> Nadia Jolie <small
														class="contacts-list-date float-right">2/20/2015</small>
												</span> <span class="contacts-list-msg">I'll call you back
														at...</span> <!-- /.contacts-list-info -->
												</a>
											</div></li>
										<!-- End Contact Item -->
										<li><div class="contacts-list-info">
												<a href="#"> <img class="contacts-list-img"
													src="dist/img/user5-128x128.jpg" alt="User Avatar"> <span
													class="contacts-list-name"> Nora S. Vans <small
										...
										<li><div class="contacts-list-info">
												<a href="#"> <img class="contacts-list-img"
													src="dist/img/user6-128x128.jpg" alt="User Avatar"> <span
													class="contacts-list-name"> John K. <small
										...
										<li><div class="contacts-list-info">
												<a href="#"> <img class="contacts-list-img"
													src="dist/img/user8-128x128.jpg" alt="User Avatar"> <span
													class="contacts-list-name"> Kenneth M. <small
														class="contacts-list-date float-right">1/4/2015</small>
												</span> <span class="contacts-list-msg">Never mind I
														found...</span> <!-- /.contacts-list-info -->
												</a>
											</div></li>
										<!-- End Contact Item -->
									</ul>
