...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('table .edit').on('click', function() {
			...
			$.ajax({
				type: 'GET',
				url: '${pageContext.request.contextPath}/admin/user_management',
	...
	<section class="content">
								...
								<tbody>
									<c:forEach items="${userList}" var="user" varStatus="STT">
										<tr>
											<td>${STT.index + 1}</td>
											<td>
												<c:if test ="${user.id_role == 1}">User</c:if>
												<c:if test ="${user.id_role == 2}">Vendor</c:if>
												<c:if test ="${user.id_role == 3}">Admin</c:if>
											</td>
		...
		<div id="blockuser" class="modal fade">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<form method="post"
						action="${pageContext.request.contextPath}/admin/user_management?action=block">
						<div class="modal-header">
		...
		<div id="unblockuser" class="modal fade">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<form method="post"
						action="${pageContext.request.contextPath}/admin/user_management?action=unblock">
						<div class="modal-header">
