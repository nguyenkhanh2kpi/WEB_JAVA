	...
	<section class="content">
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">Quản lý sản phẩm ${infoStore.name}</h3>
						</div>
						...
						<div class="card-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<c:forEach items="${listProductActive}" var="storeList" varStatus="STT">
										<tr>
											<td>${STT.index + 1}</td>
											...
											<td>${storeList.price}</td>
											<td>${storeList.quantity}</td>
											<td>${storeList.sold}</td>
											<td>${storeList.categoryName}</td>
		...
		<div id="blockuser" class="modal fade">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<form method="post"
						action="${pageContext.request.contextPath}/admin/store/product/list?action=block">
		...
		<div id="unblockuser" class="modal fade">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<form method="post"
						action="${pageContext.request.contextPath}/admin/store/product/list?action=unblock">
						<div class="modal-header">
